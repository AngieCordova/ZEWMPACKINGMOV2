sap.ui.define([
    ...
    return Controller.extend("AvocadoProyecto.AvocadoProyecto.modules.Despachofruta.controller.Detalledespachofruta", {
        ...
        onInit: async function() {
            ...
            await bus.subscribe("splitApp", "DetalledespachofrutaView", this._busSuscribe, this);
        ...
        onVolverListado: function() {
            var oViewId = "DespachofrutaView";
            var oPathView = "AvocadoProyecto.AvocadoProyecto.modules.Despachofruta.view.Index";
            this.dataBus.oView.oController.onSplitRouter(oViewId, oPathView, 0);
        ...
        onCalcularDuracion: async function(oEvent) {
            ...
            try {
                ...
                //SCH
                var FechaSelec = new Date(this.byId("date-fecha_produccion").mProperties.dateValue);
                var today = new Date();
        ...
        onGuardar: async function() {
            ...
            if (this._QueCasoEs == 1) {
                ...
                if (oModel.getProperty("/TempSetPoint") == '') {
                    MensajesObject._MensajeError("Debe ingresar un valor de Temp. Set Point");
                    return;
                }
            ...
            if (this._QueCasoEs == 1) {
                sMensaje = "Se iniciara el proceso de enfriamiento. \n Está seguro?";
            }
