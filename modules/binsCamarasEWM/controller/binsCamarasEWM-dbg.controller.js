sap.ui.define([
    ...
    return Controller.extend("AvocadoProyecto.AvocadoProyecto.modules.binsCamarasEWM.controller.binsCamarasEWM", {
        ...
        oView: new Object(),
        idMasterDialog: "binsCamarasEWMView",
        sorterTable: [],
        ...
        onInit: function() {
            ...
            bus.subscribe("splitApp", "binsCamarasEWMView", this._busSuscribe, this);
            */
        ...
        */
        ...
        onLoadDetail: function() {
            ...
            // oModelService.read("/ObtenerBinsEnCamarasSet", {
            oModelService.read("/ObtenerBinsEnCamarasSet", {
            ...
            //DG - Fin  
                success: function(result, response) {
                    ...
                    /*-----------------------------*/
                    //result.results = result.results.filter(dat => dat.TIEMPO_REPOSO != '');
                    /*-----------------------------*/
            ...
            for (let i in othat.scope.filtrado) {
                if (othat.scope.filtrado[i] && othat.scope.filtrado[i] != "") {
                    aFilters.push(new sap.ui.model.Filter({
                        path: i,
                        test: function(oValue) { return (oValue.toString().toUpperCase().indexOf(othat.scope.filtrado[i].toString().toUpperCase()) >= 0); }
                    }));
                }
            }
        ...
        onPrintReport: function() {
            ...
            var bodyContent = $("#binsCamarasEWMView--idReportTable").html();
        ...
        onGetCSV: function() {
            ...
            for (let index = 0; oBinding.getColumns()[index]; index++) {
                console.log(oBinding.getColumns()[index].getHeader().getItems()[1]);
                // if (oBinding.getColumns()[index].getHeader().getItems()[1].getProperty('text') != "") {
                if (oBinding.getColumns()[index].getHeader().getItems()[1] && oBinding.getColumns()[index].getHeader().getItems()[1].getProperty('text') != "") {
