sap.ui.define([
    ...
    return {
        ...
        onAbrirMatchcode: function(oEvent, sNombre) {
            ...
            var sPath = "AvocadoProyecto.AvocadoProyecto.modules.altaPtIndustrial.fragments.matchcodes.";
        ...
        onAgregarValorMatchcodeGuias: function(oEvent) {
            var oView = this.getView();            
            var oItem = oEvent.getParameter("selectedItem");

            var oBinding = oItem.getBindingContext("mAyudaGuias");
            var oElement = oBinding.getObject();
            var oSelected = oItem.getTitle();
        ...
        onAgregarValorMatchcodeImpresora: function(oEvent) {
            ...
            var oBinding = oItem.getBindingContext("mAyudaImpresoras");
            var oElement = oBinding.getObject();
            var oSelected = oItem.getTitle();
            ...
            var sNombreFragmento = "AyudaImpresora";
            this.onCerrarFragmento(sNombreFragmento);
            
        },
        //Fin SCH-Proyecto Guatemala
        
        //Inicio SCH - Agregar impresora en remente de pallets
        onAgregarValorMatchcodeGrupoImpresora: function (oEvent) {
        ...
        onFiltrarDatosMatchcodeGrupoImpresora: function (oEvent) {
            var oSource = oEvent.getSource();
            var sValue = oEvent.getParameter("value");

            var oFiltros = new Array(
                new sap.ui.model.Filter("IdImpresora", sap.ui.model.FilterOperator.Contains, sValue)
            );
      ...
      //Fin SCH - Agregar impresora en remente de pallets
