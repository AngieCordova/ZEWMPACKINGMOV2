sap.ui.define([
    ...
    return Controller.extend("AvocadoProyecto.AvocadoProyecto.modules.inventarioContenedoresEWM.controller.inventarioContenedoresEWM", {
        ...
        oView: new Object(),
        idMasterDialog: "inventarioContenedoresEWMView",
        sorterTable: [],
        ...
        onInit: function() {
            ...
            bus.subscribe("splitApp", "inventarioContenedoresEWMView", this._busSuscribe, this);
            */
        ...
        */
        onLoadDetail: function() {
            ...
            oModelService.read("/ObtenerInventarioDeContenedoresSet", {
            	filters: aFilters,
                success: function(result, response) {
                    ...
                    let conta = {};
                    result.results.forEach(element => conta[element.COD_CONTENEDOR] != undefined ? conta[element.COD_CONTENEDOR]++ : conta[element.COD_CONTENEDOR] = 1);
                    for (let value in conta) { othat.scope.totalRows++; }
        ...
        handleFilter: function() {
            ...
            */
            ...
            let findArr = [];
            oBinding.aIndices.forEach(element => findArr.push(oBinding.oList[element]))
            let conta = {};
            findArr.forEach(element => conta[element.COD_CONTENEDOR] != undefined ? conta[element.COD_CONTENEDOR]++ : conta[element.COD_CONTENEDOR] = 1);
            for (let value in conta) { othat.scope.totalRows++; }
        ...
        onPrintReport: function() {
            ...
            var bodyContent = $("#inventarioContenedoresEWMView--idReportTable").html();
