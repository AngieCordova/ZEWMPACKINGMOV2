sap.ui.define([
    ...
    return Controller.extend("AvocadoProyecto.AvocadoProyecto.modules.remontarPallet.controller.Index", {
        ...
        onInit: async function () {
            ...
            bus.subscribe("splitApp", "RemontarPalletsIndexView", this._busSuscribe, this);

            var oView = this.getView();
            var oTable = oView.byId("table-lista_palets_incompletos");

            var oData = new sap.ui.model.odata.v2.ODataModel("/sap/opu/odata/sap/ZEWM_0013_SRV");
            oView.setModel(oData, "ZEWM_0013");
        ...
        cargarListadoPalletsPantallaInicial: async function () {
            var oView = this.getView();
            var oData = oView.getModel("ZEWM_0013");
            var oTable = oView.byId("table-lista_palets_incompletos");
        ...
        onSelectItem: async function (oEvent) {
            ...
            var oView = this.getView();
            var oModelOdata = this.getView().getModel("ZEWM_0013");
           ...
           //Inicio SCH
            ...
            var sPathFragmento = "AvocadoProyecto.AvocadoProyecto.modules.remontarPallet.fragments." + sNombreFragmento;
        ...
        onAbrirAyudaBusquedaGrupoImpresora: function (oEvent) {
            ...
            var sPath = "AvocadoProyecto.AvocadoProyecto.modules.remontarPallet.fragments." + sNombreFragmento;
        ...
        onGuardarPalletsRemontar: function () {
            var oView = this.getView();
            let oModelOdata = oView.getModel("ZEWM_0013");
            var oModelCabecera = oView.getModel("CABECERA");
