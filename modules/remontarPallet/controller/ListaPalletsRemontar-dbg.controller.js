sap.ui.define([
    ...
    return Controller.extend("AvocadoProyecto.AvocadoProyecto.modules.remontarPallet.controller.ListaPalletsRemontar", {
        ...
        onPressInicion: function() {
            ...
            var oPathView = "AvocadoProyecto.AvocadoProyecto.modules.remontarPallet.view.Index";
            this.dataBus.oView.oController.onSplitRouter(oViewId, oPathView, 21);
        ...
        onGuardarPalletsRemontar: function() {
            var oView = this.getView();
            var oModelOdata = oView.getModel("ZEWM_0013");
